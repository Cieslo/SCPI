...
public class DefaultECP3561WorkaroundService implements ECP3561WorkaroundService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultECP3561WorkaroundService.class);
	...
	{
		return DefaultECP3561WorkaroundService.class.getResourceAsStream("/ECP3561Workaround/sap-hybris-platform.png");
	}
