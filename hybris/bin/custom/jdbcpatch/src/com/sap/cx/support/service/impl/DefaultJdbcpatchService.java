...
public class DefaultJdbcpatchService implements JdbcpatchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultJdbcpatchService.class);
	...
	{
		return DefaultJdbcpatchService.class.getResourceAsStream("/jdbcpatch/sap-hybris-platform.png");
	}
