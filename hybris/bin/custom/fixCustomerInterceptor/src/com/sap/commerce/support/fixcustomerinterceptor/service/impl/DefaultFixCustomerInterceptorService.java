...
public class DefaultFixCustomerInterceptorService implements FixCustomerInterceptorService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultFixCustomerInterceptorService.class);
	...
	{
		return DefaultFixCustomerInterceptorService.class.getResourceAsStream("/fixCustomerInterceptor/sap-hybris-platform.png");
	}
